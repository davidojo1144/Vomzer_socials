  ...
  return (
    <>
      <div>
        ...
        <button className='py-1  px-6 border-none border-teal-500  rounded-full bg-teal-500 text-white hover:text-gray-300 ml-14 mt-3 '>Create account</button>
        <p className='pt-5 text-sm text-center md:text-xl'>Already have an account ?</p> 
        <button className='py-1 px-6 border-2 border-teal-300 hover:border-none rounded-full hover:bg-teal-500 text-gray-500 hover:text-white ml-20 mt-2 '>Sign in</button>
      </div>
    </>
  )
}
